...
- 符合 macOS 使用习惯的侧边栏-详情布局、带文字说明的页面操作区、原生搜索、键盘可操作选择和空状态提示
...
1. 从 [GitHub Releases](https://github.com/HanShuheng/codex-history-sync-tool/releases) 下载 `v0.1.4` 的 `CodexHistorySync.dmg`。
